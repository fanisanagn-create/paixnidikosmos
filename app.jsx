...
const App = () => {
  ...
  /* Google Sheets — version counter για re-render όταν φορτωθούν δεδομένα */
  ...
  return (
    <>
      ...
      <Products
        ...
        onAdd={addToCart} addedFlash={addedFlash}
      ...
      <aside className={`drawer ${cartOpen ? "open" : ""}`} aria-hidden={!cartOpen}>
        <div className="drawer-head">
          <h3>Το καλάθι σου</h3>
          <button className="drawer-close" onClick={() => setCartOpen(false)} aria-label="Κλείσιμο">
        ...
        {cart.length > 0 && (
          <div className="drawer-foot">
            ...
            <button className="btn primary" style={{ width: "100%", justifyContent: "center" }}>
              Παραγγελία τηλεφωνικά <Icon name="phone" size={18}/>
            </button>
            <div style={{ fontSize: 12, opacity: 0.6, marginTop: 8, textAlign: "center" }}>
              Παραλαβή από το κατάστημα ή τηλεφωνική παραγγελία
            </div>
          </div>
        )}
      </aside>
      ...
      {/* WhatsApp FAB */}
      <a
        href="https://wa.me/302221023391?text=%CE%93%CE%B5%CE%B9%CE%B1%20%CF%83%CE%B1%CF%82%2C%20%CE%AE%CE%B8%CE%B5%CE%BB%CE%B1%20%CE%BD%CE%B1%20%CF%81%CF%89%CF%84%CE%AE%CF%83%CF%89..."
        target="_blank"
        rel="noopener noreferrer"
        className="whatsapp-fab"
        aria-label="Επικοινωνία μέσω WhatsApp"
        title="Στείλε μήνυμα στο WhatsApp"
      >
