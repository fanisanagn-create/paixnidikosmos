...
const Categories = ({ onPick }) => {
  ...
  return (
    <section id="categories" data-screen-label="02 Categories">
...
const Offers = ({ dataVersion }) => {
  ...
  return (
    <section className="offers" id="offers" data-screen-label="05 Offers">
      <div className="container">
...
const Contact = () => {
  ...
  return (
    <section id="contact" data-screen-label="06 Contact" style={{ background: "var(--paper)" }}>
      <div className="container">
        <div className="section-head">
          <div>
          ...
          <div className="contact-card">
            ...
            <div className="contact-item">
              ...
              <div>
                ...
                <div className="value">{getSetting('address','Ερμού 27, Χαλκίδα 34100')}</div>
              </div>
            </div>
            <div className="contact-item">
              ...
              <div>
                ...
                <div className="value"><a href={`tel:${getSetting('phone','2221023391')}`}>{getSetting('phone_display','2221 023391')}</a></div>
              </div>
            </div>
            <div className="contact-item">
              ...
              <div>
                ...
                <div className="value"><a href={`mailto:${getSetting('email','hello@paixnidokosmos.gr')}`}>{getSetting('email','hello@paixnidokosmos.gr')}</a></div>
              </div>
            </div>
            <div className="contact-item">
              <div className="ico"><Icon name="clock" size={20}/></div>
              <div>
                <div className="label">Ύρες λειτουργίας</div>
                <div className="value">{getSetting('hours','Δευτ – Σαβ · 09:00 – 21:00')}</div>
              </div>
            </div>

            <div className="map">
              <iframe
                title="Παιχνιδοκόσμος Αναγνώστου — Χάρτης"
            ...
            <form className="contact-form" onSubmit={submit}>
              ...
              <div style={{ marginTop: 18, padding: "18px 20px", background: "var(--ink)", color: "var(--yellow)", borderRadius: 18, border: "3px solid var(--ink)" }}>
                ...
                <div style={{ fontFamily: "var(--font-display)", fontSize: 26, fontWeight: 800, marginTop: 6, color: "var(--paper)" }}>
                  Πάρε μας · {getSetting('phone_display','2221 023391')}
                </div>
    ...
    <div className="container">
      <div className="footer-grid">
        <div className="footer-brand">
          ...
          <p>Παιχνίδια, εκπαιδευτικά, εποχιακά και δώρα για όλες τις ηλικίες.
            Από την οικογένεια Αναγνώστου, με την ίδια αγάπη εδώ και 47 χρόνια.</p>
