...
function TweakNumber({ label, value, min, max, step = 1, unit = '', onChange }) {
  return (
    <div className="twk-num">
      <span style={{padding:'0 8px',fontWeight:500,color:'rgba(41,38,27,.6)'}}>{label}</span>
      <input type="number" value={value} min={min} max={max} step={step}
             style={{flex:1,border:0,background:'transparent',font:'inherit',textAlign:'right',padding:'0 8px 0 0',outline:'none',color:'inherit'}}
